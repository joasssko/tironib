<?php get_header(); ?>	
			...
			<div class="date-author-wrap">
				<?php if ( classic_show_date_single() ) { ?>
					<div class="<?php wptouch_date_classes(); ?>">
						<?php _e( "Publicado el", "wptouch-pro" ); ?> <?php wptouch_the_time( 'j F Y' ); ?>
					</div>			
				<?php } ?>	
		...
		<?php if ( classic_show_share_single() ) { ?>					
			<a id="share-post" href="#share-absolute-div" class="post no-ajax rounded-corners-8px<?php if (wptouch_get_comment_count() == 0 ) echo ' share-center'; ?>"><?php _e( "Share or Save", "wptouch-pro" ); ?></a>
		<?php } ?>
