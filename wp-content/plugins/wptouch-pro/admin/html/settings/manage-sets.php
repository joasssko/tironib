<div id="manage-sets">	
	...
	<div id="manage-info-area">
		...
		<p>
			<?php echo sprintf( __( '%sOnline Icon Generator%s', 'wptouch-pro' ), '<a href="http://www.flavorstudios.com/iphone-icon-generator" target="_blank">', '</a>' ); ?><br />
			...
			<?php echo sprintf( __( '%sDownload WPtouch Pro iPhone 4 Icon Template%s (PSD)', 'wptouch-pro' ), '<a href="' . WPTOUCH_URL . '/include/images/retina_bookmark_icon_template.zip">', '</a>' ); ?>
		</p>
	</div>
