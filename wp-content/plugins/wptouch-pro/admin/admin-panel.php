...
function wptouch_admin_menu() {
	...
	if ( $settings->put_wptouch_in_appearance_menu ) {
		add_submenu_page( 
			'themes.php', 
			__( "WPtouch Settings", "wptouch-pro" ), 
			__( "WPtouch Settings", "wptouch-pro" ), 
			'install_plugins', 
			__FILE__, 
			'wptouch_admin_panel' 
		...
		array(
			__( 'General Settings', 'wptouch-pro' ) => array( 'general-settings',
				array(
					...
					array( 'checkbox', 'menu_show_rss', sprintf( __( 'Add a link to the site %sRSS%s feed in the menu, or:', 'wptouch-pro' ), '<strong>', '</strong>' ), '' ),	
					...
					array( 'checkbox', 'menu_show_email', __( 'Add a link for the admin <strong>Email</strong> in the menu, or:', 'wptouch-pro' ), '' ),
