...
<?php get_header(); ?>
	...
	<div id="main-content" class="clearfix">
		...
		<div class="container">
            ...
            <h3 class="post-title left" style="margin-bottom:15px;">Qu&eacute; Pensamos</h3>
			
<?php if (have_posts()) : ?>
     <?php $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
            query_posts("category_name=Que Pensamos&paged=$paged"); ?>
          ...
          <?php wp_pagenavi(); ?>
			...
			<div class="col-340 right">
				...
				<ul id="sidebar">
					...
					<?php include (TEMPLATEPATH . '/sidebar_tblog.php'); ?>
