 ...
 */
?>
				<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Sidebar_noticias') ) : ?>
				
					<li><h5 class="widgettitle">Widget Ready</h5>
						<ul>
					...
					<li><h5 class="widgettitle">Pages</h5>
						<ul>
							<?php wp_list_pages('title_li=' ); ?>
						</ul>
					</li>
		
					<li><h5 class="widgettitle">Archives</h5>
						<ul>
					...
					<?php if ( is_home() || is_page() ) { ?>
						...
						<li><h5 class="widgettitle">Meta</h5>
						<ul>
							<?php wp_register(); ?>
