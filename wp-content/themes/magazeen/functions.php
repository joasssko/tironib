...
?>
	...
	<li id="featured-news" ><h5>EN VITRINA</h5>
		<ul >
			...
			<li class="clearfix">
				...
				<div class="sidebar-content">
					...
					<span><a href="<?php the_permalink(); ?>/#comments" title="Read Comments"><?php comments_number('0 Comentarios', '1 Comentario', '% Comentarios' );?></a></span>
				</div>
			</li>
...
?>
	...
	<li id="recent-news" ><h5>EN VITRINA</h5>
		<ul>
...
function register_my_menu() {
	register_nav_menu( 'primary', ( 'Navegación Principal' ) );
...
add_image_size('destacados', 560, 340, true );
}
;?>